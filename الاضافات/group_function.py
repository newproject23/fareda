    ...
    if m.text == "المحظورين عام":
        if sudo2(m):
            ...
            if lang is None:
                ...
                t = "\n✪ قائمة المحظورين عام \n≪━━━َ𝘼َِ𝙒َِ𓏺َِ 𓏺َِ𝙎َِ𝙊َِ𝙐َِ𝙍َِ𝘾َِ𝙀━━━≫\n"
                for row in lang:
        ...
        if sudo2(m):
            try:
                ...
                if lang is None:
                    ...
                    t = "\n✪ قائمة المطورين \n≪━━━َ𝘼َِ𝙒َِ𓏺َِ 𓏺َِ𝙎َِ𝙊َِ𝙐َِ𝙍َِ𝘾َِ𝙀━━━≫\n" + f"✪ [ᯓ𝐘𝐄 ||✘𝐔𝐏𝐏𝐄𝐑 •🇾🇪⇩𓄹](tg://user?id={super_sudoers[0]})\n" + f"✪ [ᯓ𝐘𝐄 ||✘𝐔𝐏𝐏𝐄𝐑 •🇾🇪⇩𓄹](tg://user?id={super_sudoers[1]})\n" + \
                        f"✪ [{n.first_name}](tg://user?id={sudoers[0]})\n\n√"
                    for row in lang:
                        t = t + f"[{row[1]}](tg://user?id={row[0]})\n"
                    await m.reply_text(t, reply_to_message_id=m.message_id, parse_mode="Markdown")
...
########################################################################################################################
    ...
    if m.text == "السورس" or m.text == "سورس" or m.text == "يا سورس":
         ...
         keyboard = InlineKeyboardMarkup(inline_keyboard=[
            ...
            [ InlineKeyboardButton ( "َ𝘼َِ𝙒َِ𓏺َِ 𓏺َِ𝙎َِ𝙊َِ𝙐َِ𝙍َِ𝘾َِ𝙀 𓏺َِ", url=f"https://t.me/P_R_C1")],
...
⍟ 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼
    ...
    if m.text == "id" or m.text == "ا" or m.text == "ا" or m.text == "ايدي" or m.text == "id"\
            or m.text == "ايديه":
...
ٴ≪━━━َ𝘼َِ𝙒َِ𓏺َِ 𓏺َِ𝙎َِ𝙊َِ𝙐َِ𝙍َِ𝘾َِ𝙀━━━≫ٴ
